...
BasicGame.Preloader.prototype.preload = function(){
  ...
  this.load.audio('mainMenuMusic',['assets/music/main_menu.wav','assets/music/main_menu.ogg'],true);
  this.load.audio('level001Music',['assets/music/level001.wav','assets/music/level001.ogg'],true);
